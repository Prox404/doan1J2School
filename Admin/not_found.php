...
<head>
    <style>
@import url('https://fonts.googleapis.com/css2?family=Righteous&display=swap');        html,
        body {
            height: 100%;
            width: 100%;
            margin: 0px;
...
<body>
    ...
    <div class="error">
        ...
        <button class="error__button error__button--active"> <a href="index.php" style="color: #fff; text-decoration:none;">Homepage</a></button>
    </div>
