<body>
  <div class="header shadow-box">
    ...
    <ul class="header-menu">
      ...
      <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) { ?>
        ...
        <?php if (isset($_SESSION['number_item'])) { ?>
          <?php if ($_SESSION['number_item'] > 0) { ?>
            <div class="bubble"><?php $_SESSION['number_item'] ?></div></a></li>
          <?php } ?>
        <?php } ?>
        <li>
      ...
      <?php } else { ?>
        <li data-toggle="modal" data-target="#modal-signin" class="signin-btn">
          Đăng nhập
        </li>
        <li data-toggle="modal" data-target="#modal-signup" class="signup-btn">
          Đăng ký
        </li>
      <?php } ?>
    </ul>
